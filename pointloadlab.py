...
Original file is located at
    https://colab.research.google.com/drive/1HBc_pLARZfagPzIitYeqO0cae0b4Xo-h
"""
...
delta = np.trapezoid(M * m_t, x) / (E * I)
            # x = np.arange(0, L + dx, dx) knows to take range 0 to L
...
print("Rotation, theta = {:.6e} in".format(theta))